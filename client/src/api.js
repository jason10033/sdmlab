...
export const api = {
  ...
  getQueries: (id) => req('GET', `/projects/${id}/evidence/queries`),
  suggestQueries: (id) => req('POST', `/projects/${id}/evidence/queries/suggest`),
  saveQueries: (id, d) => req('PUT', `/projects/${id}/evidence/queries`, d),
  queryCounts: (id, queries) => req('POST', `/projects/${id}/evidence/queries/counts`, { queries }),
